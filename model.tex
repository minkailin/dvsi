...
Having identified the entropy of an isothermal dusty gas, we can also
define the disk vertical buoyancy frequency $N_z$ as   
...
where the second equality assumes a vertically isothermal disk. A
similar definition exists for the radial buoyancy frequency
$N_r$. Typically in a thin, smooth disk we have $|N_r|\ll |N_z|$. 
...
\end{align}
Such an isothermal dusty disk is \emph{unstable} because there is no effective vertical 
