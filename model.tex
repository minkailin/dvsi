...
system to `overshoot' its equilibrium. {\bf should be overshoot the max displacement}
...
beyond its equilibrium volume. {\bf should be: expand beyond the max
...
parcel's contraction to over-shoot its equilibrium density. {\bf
