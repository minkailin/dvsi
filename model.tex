...
For the mixture's temperature evolution, Eq. \ref{tempeq}, reflects the gas energy equation. 
Here $\gamma$ is 
the adiabatic index; $\mathcal{H}$ represents gas heating and $\mathcal{H}_\mathrm{eff}$ 
...
We simplify the energy equation by considering short cooling 
...
%dust-fraction. 
Writing $\tepsilon=\tepsilon(P,\rho)$ using Eq. \ref{eos}
\begin{align*}
