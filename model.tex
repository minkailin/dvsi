...
\begin{align}  
  ...
  - \frac{\rhog\rhod}{\rho}\frac{\Delta\bm{v}}{\tstop}. 
\end{align}
is the dust-gas friction force per unit volume, where
\begin{align}
  \Delta\bm{v} \equiv\bm{v}_\mathrm{d} - \bm{v}_\mathrm{g} 
\end{align}
...
\tstop\rhog/\rho$ used in some studies
\citep[e.g.][]{youdin05a,jacquet11}.   

In general $\Delta\bm{v}$ obeys a complicated evolutionary equation
...
\begin{align}
  \Delta\bm{v} = \frac{\nabla
    P}{\rhog}\tstop 
\end{align}
\citep{youdin05a,jacquet11}. This equation implies that dust particles
