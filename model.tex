...
$\mathcal{C}$. However, given the complexity of $\mathcal{C}$ (
Appendix \ref{lin_dust}), we might generally expect the system to
support a range of modes, stable and unstable. 
On physical grounds, growing modes  
\emph{must} be so by causing a phase lag between pressure and total
density.    
