...
\subsection{Incompressible { gas} limit}

 We can set $\zeta = 0$ or consider $c_s^2\to \infty$ to
obtain the incompressible { gas} limit. Using $\tau_\mathrm{s} \equiv
...
{ Here we check if the above explicit solutions are
...
{ Ultimately, the validity of these assumptions are justified
