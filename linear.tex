...
hence find growing oscillations. This implies the streaming instability stems
from the gas pressure evolution lagging behind that of the total (and hence dust) density.  

Notice also eigenfrequencies agree better for 
smaller pressure-density phase lags. While this is generally true with decreasing $\tstop$, other 
problem parameters may affect the magnitude of this phase lag, and hence the validity of the one-fluid model.  
For example, `linA' has a larger $\tstop$ than `linB', but linA's one and 
two-fluid growth rates differ by $\sim 1\%$; compare to $\sim 10\%$ error for linB. 
However, linB has a larger phase lag. This means that the effective coupling strength between dust and gas 
...
\begin{deluxetable*}{llrrrrrr}
  ...
  \tablehead{
    ...
    \colhead{$\mathcal{W}$ (arbitrary units)} &
      \colhead{Pressure lag}
  }
\startdata
 linA, \cite{youdin07b} &  $0.1$       & 3.0 & 30    & $-0.3480 +
 0.4190\ii$ & $0.3640 + 0.4249\ii$ & $0.026$ & $42\degr$\\ 

linB, \cite{youdin07b} & $0.1$        &  0.2 & 6 & $0.4999 +
0.0155\ii$&   $-0.4981 + 0.0054\ii$  & $1.75$ & $88\degr$ \\

linC,  \cite{bai10b}  & $10^{-2}$   &  2.0 & 1500&   $0.1049 +
0.5981\ii$   &  $0.1338 + 0.6650\ii$  & $3.57\times10^{-4}$& $78\degr$ \\

linD, \cite{bai10b} &  $10^{-3}$   &  2.0 & 2000 & $0.3225 + 
0.3154\ii$& $0.3219 + 0.3154\ii$ &  $1.85\times10^{-4}$ & $21\degr$ 
\enddata
\end{deluxetable*}
