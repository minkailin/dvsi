...
For example, `linA' has a larger $\tstop$ than `linC', but linA's one and 
two-fluid growth rates differ by $\sim 1\%$; compare to $\sim 10\%$ error for linC. 
However, linC has a larger phase lag. This means that the effective coupling strength between dust and gas 
