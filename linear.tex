\section{Quasi-global linear problem}\label{linear_problem}
...
verticall-stratified problem, as we pursue below. 

However, in the special case of an unstratified disk (neglecting the vertical
component of the stellar gravity), we may also Fourier analyze in $z$
to obtain a local dispersion relation. This is done in 
Appendix \ref{compressible_streaming}. There we show the above linearized
