...
%dust layer is. 
We show in the limit of perfect coupling, that  dust settling in
...
buoyancy forces of a isothermal dusty disk. 
...
dust-gas drag instabilities in disks, for example the streaming
instability, as a phase lag between the pressure 
and density of a dusty gas, which is   
analogous to pulsational instabilities 
in stars.  
\end{abstract}
