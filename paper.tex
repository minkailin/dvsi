...
\begin{abstract}
  Small dust particles embedded in gaseous protoplanetary disks are subject
  to strong dust-gas friction, causing them to almost follow the gas
  flow. This is similar to the conservation of entropy following an
  adiabatic fluid.  We show that in the strong drag
...
gas, from which we place quantitative constraints on the sharpness of 
...
dust. We find that  dust-loading reduces VSI growth rates. The presence of
strongly-coupled dust particles preferentially stabilize VSI modes with small radial
...
to provide thermodynamical interpretations of  other dusty instabilities in protoplanetary disks. 
\end{abstract}
