...
\begin{abstract}
  ...
  %Tightly-coupled dust particles
  % in protoplanetary disks almost follow the gas flow. 
...
\citep{youdin05a,youdin07b,johansen07} and secular gravitational
instabilities \citep{ward00,youdin11,takahashi14} that lead to
planetesimal formation. More recently, new dusty instabilities have
also been uncovered \citep{loren15,loren16,lamb16}
...
by a stopping time $\tstop$ --- the characteristic timescale for the
relative velocity between gas and dust to decay. Thus small $\tstop$
...
This can make the two-fluid or Lagragian particles approach
numerically challanging; but is straight forward to model in the
...
can then adopt a locally isothermal equation of state $P = c_s^2\rhog$
...
fact the usual hydrodynamic equations, including a precise 
definition of the entropy isothermal dusty gas. We describe approximate 
...
present numerical results \S\ref{results}. We summarize and discuss
