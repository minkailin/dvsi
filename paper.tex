...
\citep{chiang10}. Although the overall dust content is typically small
($\sim 1\%$ by mass), their presence can have profound impacts on the
gas dynamics and vice versa.  
...
%particles 
Current state-of-the-art models of dusty protoplanetary disks
directly simulate pure gas dynamics with explicit Lagragian dust
particles.    
%refs 
...
A simpler framework is to model the dust population as a pressureless
fluid. The advantage is that standard hydrodynamics codes may be
modified by adding a 
%The two-fluid model is also suitable for analytic studies. 



%how to model dusty gas? 
...
We draw the physical and mathematical parallel between dusty gas and
adiabatic pure gas. 
%suitable for 
%analytic studies 
