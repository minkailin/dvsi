...
they reproduce previous results on SGI and SI. In \S\ref{results} we
...
$r$ from the star \citep{chiang97}. Since $P\propto \rhog T$ for an ideal gas, the pressure of a gas parcel varies with 
position as well. There is no reason to expect $P$ and $\rhog$ to
be in phase. In fact, we will show that this is a fundamental property of 
