...
\item dust-loading generally stabilizes the vertical shear
  instability, which can be understood as a effect of dust-induced
  buoyancy forces. 
\end{inparaenum}  
%growth rates, and 
...
pure hydrodynamics, as it allows us to understand dusty-gas dynamics
within a thermodynamic framework. 
