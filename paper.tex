...
\S\ref{linear_problem} we list the linearized equations. We solve them 
to recover SGI in \S\ref{sgi}, to interpret the SI in \S\ref{si}, and
in  \S\ref{results} to extend the VSI to dusty disks. We  
