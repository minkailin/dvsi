...
We now vary the dust layer thickness $\Hd$ but hold 
$Z \equiv \epsilon_0 \Hd/\Hg = \text{constant,}$ 
so that $\Sigma_\mathrm{d}/\Sigma_\mathrm{g}$ is
fixed. This then gives the required midplane dust-to-gas ratio.    
Since we will consider thin dust layers, here we use a smaller
...
\begin{figure}
  ...
  \caption{Vertical shear rate (solid) compared to vertical buoyancy
    ...
    with dust-to-gas mass ratio $Z=0.03$ and dust thickness $\Hd=0.1\Hg$
