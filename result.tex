...
For simplicity we input constant values of the midplane dust-to-gas ratio
$\epsilon_0$ and its characteristic height $H_\epsilon$, the latter being 
specified via the dust thickness $\Hd$. 
