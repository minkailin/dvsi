...
polytropic dusty gas is given by extrema in  
\begin{align}
  \mathcal{V} =
...
exciting `critical layers' which role 
...
1$). This limits its applicability to typical protoplanetary disks at
...
also induces an effective buoyancy. This effect is maximized when dust is
...
In this paper we develop a physical analogy between isothermal 
