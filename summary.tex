...
0.2$. However, we also find the mode marked by the blue asterisk with
frequency 
\begin{align*}
...
\begin{figure}
  ...
  \caption{Unstable modes in a locally isothermal, dusty disk
    ...
    Fig. \ref{result2d_loren}, is associated with finite dust-gas
    drag.   
...
\begin{figure}
  ...
  \caption{The mode marked by the blue asterisk in
    Fig. \ref{compare_eigenvals_ts0d02}. This is a possible eigenmode
    of the dusty instability discovered by  
