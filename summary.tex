...
results from neglecting terms of $O(|\widetilde{\bm{v}}|^2)$ when converting
...
fact, typical disk models used for the streaming
instability have negligible background radial density gradient, then  
$N_r^2= -\rho F_r^2/P$.  
...
purely adiabatic gas ($\tcool\to\infty$). This limits its
